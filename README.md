...
- **Independently verified translation.** The *Anhang* translation has been
  ...
  each pass produced a fresh translation from the corrected German and
...
- **Translation.** Translation models and general LLMs were surveyed for
  ...
  result was then verified adversarially by five independent models: Grok
  4.6, GPT-5.5 (High Thinking), Gemini 3.7 Flash, and DeepSeek v4.0 Flash
  (0731) on the full document, and Kimi K3 on a nine-page sample. The roster
  is chosen per document for
